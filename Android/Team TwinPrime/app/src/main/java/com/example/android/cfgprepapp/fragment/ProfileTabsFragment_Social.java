...
public class ProfileTabsFragment_Social extends Fragment implements OnClickListener {
	...
	public static ProfileTabsFragment_Social newInstance(int position) {
		ProfileTabsFragment_Social f = new ProfileTabsFragment_Social();
		Bundle b = new Bundle();
