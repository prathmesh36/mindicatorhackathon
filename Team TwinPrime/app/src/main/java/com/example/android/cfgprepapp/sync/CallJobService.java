...
public class CallJobService {
    ...
    synchronized public static void scheduleReminderNotification(@NonNull final Context context) {
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                 ...
                 */
                .setTrigger(JobDispatcherUtils.periodicTrigger(REMINDER_INTERVAL_MINUTES,SYNC_FLEXTIME_SECONDS))
